      ...
      <div className="container">
        ...
        <div className="profile-links">
          <div className="button">
            <button onClick={e => setMenu("main")}>Главная</button>
          </div>
          <div className="button">
            <button onClick={e => setMenu("my orders")}>Мои заказы</button>
          </div>
          <div className="button">
            <button onClick={e => setMenu("bonus account")}>Бонусный счет</button>
          </div>
          <div className="button">
            <button onClick={e => setMenu("personal information")}>Личная информация</button>
          </div>
          <div className="button">
            <button onClick={e => setMenu("my addresses")}>Мои адреса</button>
          </div>
          <div className="button">
            <button onClick={e => setMenu("subscribe to news")}>Подписка на новости</button>
          </div>
        </div>
